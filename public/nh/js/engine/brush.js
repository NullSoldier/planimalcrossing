...
function Brush(board) {
    ...
    this.fillImage = this.R.image(Board.toFullPath('img/flat-tiles/'+ this.type +'.png'), 0 , 0, 16, 16);
    ...
    this.changeBrush('maptile-water-full');
...
Brush.prototype.changeBrush = function changeBrush(newType) {
    ...
    this.fillImage.attr({
        href: Board.toFullPath('img/flat-tiles/'+ newType +'.png')
    });
